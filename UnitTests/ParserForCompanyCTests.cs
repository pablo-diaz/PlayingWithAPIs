...
namespace UnitTests
{
    public class ParserForCompanyCTests
    {
        [Test]
        ...
        {
            var parsedResult = new ParserForCompanyC().Parse(goodResponse);
        ...
        {
            var parsedResult = new ParserForCompanyC().Parse(wrongResponse);
